...
unset($__errorArgs, $__bag); ?>" name="nama" value="<?php echo e(old('nama')); ?>"placeholder="">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>"placeholder="">
...
unset($__errorArgs, $__bag); ?>" name="tentang" value="<?php echo e(old('tentang')); ?>"placeholder="">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-12 mt-3 mb-3">
                    <div class="form-group">
                        ...
                        <textarea id="pesan" class="form-control <?php $__errorArgs = ['pesan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required name="pesan" value="<?php echo e(old('pesan')); ?>"placeholder=""></textarea>
                    </div>
                </div>
                <br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel101\resources\views/contact/create.blade.php ENDPATH**/ ?>